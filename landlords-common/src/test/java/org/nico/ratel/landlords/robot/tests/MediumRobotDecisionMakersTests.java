...
public class MediumRobotDecisionMakersTests {
	...
	private List<Poker> buildPokers(String[] values){
		...
		for(Object v: values) {
			...
			pokers.add(new Poker(PokerDesc.parseByName((String)v), PokerSuit.CLUB));
		}
		return pokers;
	}
	...
	public void testMedium_1() {
		...
		//DouDiZhuPokerSell lastSell = PokerHelper.checkPokerType(buildPokers(new Object[] {5,5}));
		//DouDiZhuPokerSell sell = mediumRobot.howToPlayPokers(lastSell, self);
		//if(sell == null) {
